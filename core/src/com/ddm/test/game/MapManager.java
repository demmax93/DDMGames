...
public class MapManager {
    ...
    public final static float UNIT_SCALE = 0.01f;  //1 / 16f

    public MapManager() {
        playerStart = new Vector2(0, 0);
        mapTable = new Hashtable();
        mapTable.put(TOP_WORLD, "core/assets/maps/topworld.tmx");
        mapTable.put(TOWN, "core/assets/maps/topworld.tmx");
        mapTable.put(CASTLE_OF_DOOM, "core/assets/maps/topworld.tmx");
